    ...
    "paths": {
        ...
        "/api/v1/admin/stats": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Admin statistics including user counts, link metrics, and system status",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/admin/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "User data and operations",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Login successful with access_token and refresh_token",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/auth/refresh": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully refreshed token with new access_token and refresh_token",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/auth/register": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Registration successful with user details",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/premium/analytics/detailed": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/public/{shortCode}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Short URL code for redirection",
                        "name": "shortCode",
                        "in": "path",
                        "required": true
                    }
